...
// 	//recup le carnet d'address serialaisé à partir du local 
// 	//storage

// 	var getFromStorage=window.localStorage.getItem("addressBook");
// 	console.log(getFromStorage);


// 	//désérialiser en  array addressBook
// 	var addressBookArray=JSON.parse(getFromStorage);

// 	//ajouter oContact ds array addressBook
// 	addressBookArray=addressBookArray.push(oContact)

// 	// sérialiser en  l'array addressBook
