<?php
    ...
    class Student
    {
        ...
        public function addNote($fNote)
        {
            if (is_array($fNote))
            {
                $this->aNotes = array_merge($this->aNotes, $fNote);
            }
            else {
                $this->aNotes[] = $fNote;
            }
        ...
        {
            if ($this->getAverage() > $oOtherStudent->getAverage())
            {
                return "L'étudiant".$this->getName()." a une moyenne supérieur";
            }
            else
            {
                return "L'étudiant".$oOtherStudent->getName()." a une moyenne supérieur";
            }
        }
